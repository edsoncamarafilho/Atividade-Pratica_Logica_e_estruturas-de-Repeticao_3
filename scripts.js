...
document.write(`A menor altura do grupo é: ${menorAltura} metros <br><br>`);
document.write(`A maior altura do grupo é: ${maiorAltura} metros <br><br>`);
